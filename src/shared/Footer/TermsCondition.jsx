      ...
      <div className="mb-16">
        ...
        <div className="ml-4 mr-4 md:ml-36 lg:ml-48 md:mr-36 lg:mr-48 ">
          ...
          <p className="mb-6 text-lg">
            This website is operated by Fitment Craft. Throughout the site, the
            terms “we”, “us” and “our” refer to Fitment Craft. Fitment Craft
          ...
          <h4 className="text-xl font-medium mb-6 mt-6">
          ...
          <p className="text-lg">
            ...
            provided, without express wrote permission by us.
          </p>
          <p className="text-lg">
